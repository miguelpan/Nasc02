...
public class MainViewController implements Initializable {
	...
	public void onMenuItemFuncaoAction() {
		loadView("/gui/FuncaoLista.fxml",(FuncaoListaController controller) -> {// Tipo e nome
			controller.setFuncaoService(new FuncaoService());// Chamando inicialização do controler FuncaoListaController
	...
	/**
	 * Função generica para abrir tela.
	 * Essa função serve pra pegar o VBox da janela que foi passada como parametro e substituir na mainView principal.
